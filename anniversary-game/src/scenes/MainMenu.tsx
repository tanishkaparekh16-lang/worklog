...
import { arcadeGames, chapters, meta } from '../data/relationshipData'
          ...
          <div className="postin">
            ...
            <div className="mlist">
              ...
              >
                ...
                <span className="no">{arcadeOpen ? `${p.arcadeDone.filter((id) => arcadeGames.some((m) => m.id === id)).length}/${arcadeGames.length}` : '···'}</span>
              </button>
